...
public:
 ...
 //Return the current number of accesses of a key
  int getTimes() const {
	  return curr->getAccess();
  }

  //Sets the number of accesses of a key
  void setTimes(int n) {
	  curr->setAccess(n);
  }

  //Return to front item of the list
  E headValue() {
	  return head->next->element;
  }

  //Return to end item of the list
  E tailValue() {
	  return tail->element;
  }
